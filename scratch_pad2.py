...
df_linked_true_cat_1_n = len(df_linked_true_cat_1)

print(f"Number of true matches in category 1: {df_linked_true_cat_1_n}")
print(f"Number for missed matches in category 1: {len(df_unlinked_false_cat_1)}")
